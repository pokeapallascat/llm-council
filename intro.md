...
### Optional web UI (ignored for terminal-only use)
If you ever want the original web app, see `README.md` for FastAPI/React/OpenRouter setup. It is not required for the terminal council flow.
